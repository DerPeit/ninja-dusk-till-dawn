...
function Device(options) {
  ...
  var updateMonitors = function() {
    ...
    for (var i in self.locations) {
      ...
      var weatherInfo = Suncalc.getTimes(
        new Date(),
        location.coords.lat,
        location.coords.lon);

      var o = {
        "night-end": weatherInfo.nightEnd,
        "astronomical-dawn-start": weatherInfo.nightEnd,
        "astronomical-dawn-end": weatherInfo.nauticalDawn,
        "nautical-dawn-start": weatherInfo.nauticalDawn,
        "nautical-dawn-end": weatherInfo.dawn,
        "civil-dawn-start": weatherInfo.dawn,
        "civil-dawn-end": weatherInfo.sunrise,
        "sunrise-start": weatherInfo.sunrise,
        "sunrise-end": weatherInfo.sunriseEnd,
        "morning-golden-hour-start": weatherInfo.sunriseEnd,
        "morning-golden-hour-end": weatherInfo.goldenHourEnd,
        "daylight-start": weatherInfo.goldenHourEnd,
        "daylight-end": weatherInfo.goldenHour,
        "evening-golden-hour-start": weatherInfo.goldenHour,
        "evening-golden-hour-end": weatherInfo.sunsetStart,
        "sunset-start": weatherInfo.sunsetStart,
        "sunset-end": weatherInfo.sunset,
        "civil-dusk-start": weatherInfo.sunset,
        "civil-dusk-end": weatherInfo.dusk,
        "nautical-dusk-start": weatherInfo.dusk,
        "nautical-dusk-end": weatherInfo.nauticalDusk,
        "night-start": weatherInfo.night
      };
      
      self.logger.debug("Weather info for '" + location.internal_id + "' has been calculated: " + JSON.stringify(o));
      location.monitors = createMonitorFactory(location.id, o);
    }
